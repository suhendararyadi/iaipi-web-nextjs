          ...
          <div className="col-lg-12">
            <div className="prodi-header-card">
              <div className="prodi-header-left">
                <div className="prodi-badge">IAT</div>
                <div className="prodi-title-wrapper">
                  <h2>Program Studi Ilmu Al-Quran dan Tafsir</h2>
            ...
            {activeTab === 'karir' && (
              <div className="tab-content-modern fade-in">
                <div className="content-card">
                  ...
                  <p className="mb-5">Lulusan Program Studi Ilmu Al-Quran dan Tafsir memiliki peluang karir yang luas di berbagai sektor.</p>
            ...
            <div className="prodi-cta-footer">
              <div className="cta-left">
                ...
                <div>
                  ...
                  <p>Daftar sekarang dan jadilah ahli dalam bidang Ilmu Al-Quran dan Tafsir</p>
                </div>
              </div>
