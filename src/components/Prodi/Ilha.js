...
const IlhaContent = () => {
  ...
  const kurikulumSingkat = [
    {
      ...
      matkul: [
        ...
        { nama: "Pengantar Ilmu Hadis", sks: 2 },
    ...
    },
    {
      semester: "Semester 3",
      totalSKS: 24,
      fokus: "Pendalaman Ilmu Hadis & Metodologi",
      matkul: [
  ...
  const profilLulusan = [
    ...
    { icon: "fa-institution", title: "Da&apos;i & Mubaligh", desc: "Penyebar ajaran Islam berbasis hadis" },
          ...
          <div className="col-lg-12">
            <div className="prodi-header-card">
              <div className="prodi-header-left">
                <div className="prodi-badge">ILHA</div>
                <div className="prodi-title-wrapper">
                  <h2>Program Studi Ilmu Hadis</h2>
            ...
            {activeTab === 'profil' && (
              <div className="tab-content-modern fade-in">
                <div className="content-card">
                  ...
                  <p className="lead-text">Program Studi Ilmu Hadis fokus pada pengkajian dan penelitian hadis Nabi Muhammad SAW sebagai sumber kedua ajaran Islam. Program studi ini mempersiapkan mahasiswa untuk menjadi ahli dalam bidang hadis yang mampu memahami, meneliti, dan mengembangkan kajian hadis secara komprehensif.</p>
            ...
            {activeTab === 'karir' && (
              <div className="tab-content-modern fade-in">
                <div className="content-card">
                  ...
                  <p className="mb-5">Lulusan Program Studi Ilmu Hadis memiliki peluang karir yang luas di berbagai sektor.</p>
            ...
            <div className="prodi-cta-footer">
              <div className="cta-left">
                ...
                <div>
                  ...
                  <p>Daftar sekarang dan jadilah ahli dalam bidang Ilmu Hadis</p>
                </div>
              </div>
