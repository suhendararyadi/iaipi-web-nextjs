          ...
          <div className="col-lg-12">
            <div className="prodi-header-card">
              <div className="prodi-header-left">
                <div className="prodi-badge">EKOSY</div>
                <div className="prodi-title-wrapper">
                  <h2>Program Studi Ekonomi Syariah</h2>
            ...
            {activeTab === 'karir' && (
              <div className="tab-content-modern fade-in">
                <div className="content-card">
                  ...
                  <p className="mb-5">Lulusan Program Studi Ekonomi Syariah memiliki peluang karir yang luas di berbagai sektor.</p>
            ...
            <div className="prodi-cta-footer">
              <div className="cta-left">
                ...
                <div>
                  ...
                  <p>Daftar sekarang dan jadilah ahli dalam bidang Ekonomi Syariah</p>
                </div>
              </div>
