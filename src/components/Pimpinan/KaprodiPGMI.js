          ...
          <div className="col-lg-4 col-md-8">
            <div className="teachers-left mt-50">
              ...
              <div className="name">
                ...
                <span>Ketua Prodi Pendidikan Guru Madrasah Ibtidaiyah (PGMI)</span>
              </div>
              ...
              <div className="tab-content" id="myTabContent">
                ...
                >
                  <div className="dashboard-cont">
                    ...
                    <div className="singel-dashboard pt-40">
                        <h5>ID Penelitian</h5>
                        <p>Sinta ID: 6842883</p>
                        <p>
                            Google Scholar  
                            <a href="https://scholar.google.co.id/citations?hl=id&user=4WFcuk0AAAAJ" target="_blank" rel="noopener noreferrer">
                             : Klik di sini
                            </a>
                        </p>
                        </div>
