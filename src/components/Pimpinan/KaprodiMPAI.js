        ...
        <div className="row justify-content-center">
          ...
          <div className="col-lg-4 col-md-8">
            <div className="teachers-left mt-50">
              ...
              <div className="name">
                <h6>Dr. Yusup Tajri, M.Pd.</h6>
                <span>Ketua Prodi Magister Pendidikan Agama Islam (MPAI)</span>
              </div>
              ...
              <div className="tab-content" id="myTabContent">
                ...
                >
                  <div className="dashboard-cont">
                    ...
                    <div className="singel-dashboard pt-40">
                        <h5>ID Penelitian</h5>
                        <p>Sinta ID: 6753948</p>
                        <p>
                            Google Scholar  
                            <a href="https://scholar.google.co.id/citations?hl=id&user=SfMuMN8AAAAJ" target="_blank" rel="noopener noreferrer">
                             : Klik di sini
                            </a>
                        </p>
                        </div>
