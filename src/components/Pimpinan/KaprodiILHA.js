...
// CATATAN: nama & jabatan disampaikan langsung oleh pengelola prodi. Riwayat
// pendidikan, Sinta ID, dan Google Scholar BELUM tersedia — jangan diisi karangan,
// lengkapi dari data resmi prodi/FTK sebelum publish.
const KaprodiILHA = () => {
  return (
                ...
                >
                  <div className="dashboard-cont">
                    <div className="singel-dashboard pt-40">
                      <h5>Tentang</h5>
                      <p>
                        Ketua Program Studi Ilmu Hadis (ILHA) Fakultas Ushuluddin Institut Agama
                        Islam Persis Garut.
                      </p>
                    </div>
                    <div className="singel-dashboard pt-40">
