...
const VisiMisi = () => {
  ...
  const misiItems = [
    { icon: "fa-book-open", text: "Keislaman dengan menjaga turats Islam dan mengambangkan syari’ah Islam yang relevan dengan perkembangan zaman, serta turut serta dalam syi’ar Islam pada masyarakat lokal, nasional dan internasional." },
    { icon: "fa-users", text: "Kemanusiaan dengan turut aktif dalam menjaga dan meningkatkan harkat manusia dalam upaya meneguhkan nilai-nilai kemanusiaan yang beradab." },
    { icon: "fa-bullhorn", text: "Kejam’iyyahan dalam bentuk peran sebagai Pusat Pengembangan Dakwah Persatuan Islam (Persis) untuk membina umat yang beradab, berilmu dan memiliki kemandirian." },
    { icon: "fa-map", text: "Kewilayahan dengan mendukung pengembangan Jawa Barat sebagai wilayah yang harmonis, berbudaya Sunda serta religius." },
    { icon: "fa-graduation-cap", text: "Keilmuan dengan menyelenggarakan pendidikan, penelitian dan pengabdian masyarakat secara profesional dengan menerapkan pembelajaran Blended Learning Online, serta mengembangkan peserta didik agar menjadi lulusan yang beriman, bertaqwa dan berakhlak mulia, berwawasan dan berkemampuan dalam ilmu pengetahuan dan teknologi mutakhir." }
  ]
              ...
              <div className="tab-content-wrapper animate-fade-in">
                <div className="visi-card">
                  ...
                  <div className="visi-statement">
                    <h4>“Terwujudnya IAI Persis Garut sebagai kampus unggulan dalam bidang keilmuan turats Islam dan menjadi Pusat Pengembangan Dakwah di Indonesia pada 2035 dan tataran global pada 2050.”</h4>
                  </div>
