  ...
  const prodiList = [
    {
      ...
      karir: ["Dosen PAI", "Peneliti Pendidikan", "Konsultan Pendidikan", "Pengembang Kurikulum"],
      keunggulan: ["Kurikulum Komprehensif", "Dosen Berkualitas", "Riset Terstruktur", "Jaringan Alumni Luas"]
    },
    {
      id: 2,
      name: "Magister Ilmu Hadis",
      code: "MIH",
      slug: "mih",
      image: "/images/prodi/ilha.jpg",
      description: "Program Magister Ilmu Hadis dirancang untuk menghasilkan ahli dan peneliti hadis yang memiliki kedalaman ilmu, kemampuan riset, dan kepakaran dalam kajian hadis Nabi Muhammad SAW secara komprehensif.",
      akreditasi: "B",
      gelar: "M.Ag.",
      durasi: "4 Semester",
      color: "#8e44ad",
      ...
      karir: ["Dosen Ilmu Hadis", "Peneliti Hadis", "Konsultan Keagamaan", "Pengembang Kajian Hadis"],
      keunggulan: ["Kurikulum Komprehensif", "Dosen Berkualitas", "Riset Terstruktur", "Jaringan Alumni Luas"]
    }
  ]
    ...
    <section id="magister-section" className="pt-70 pb-70">
      <div className="container">
        ...
        <div className="row mb-5">
          <div className="col-lg-12">
            <div className="section-title text-center pb-40">
              ...
              <h2>Pilih Program Magister Anda</h2>
            </div>
          </div>
        </div>
        ...
        <div className="row justify-content-center">
          {prodiList.map((prodiData) => (
            <div key={prodiData.id} className="col-lg-6 mb-4">
                  ...
                  <div className="row mt-4">
                    <div className="col-md-6 mb-3">
                      <div className="info-box-small">
                        <h6>Prospek Karir:</h6>
                        <ul>
                          {prodiData.karir.map((item, idx) => (
                            <li key={idx}><i className="fa fa-check-circle"></i> {item}</li>
                          ))}
                        </ul>
                      </div>
                    </div>
                    <div className="col-md-6 mb-3">
                      <div className="info-box-small">
                        <h6>Keunggulan:</h6>
                        <ul>
                          {prodiData.keunggulan.map((item, idx) => (
                            <li key={idx}><i className="fa fa-check-circle"></i> {item}</li>
                          ))}
                        </ul>
                      </div>
          ...
          <div className="col-lg-12">
            <div className="faculty-cta-footer">
              <div className="cta-content">
                ...
                <p>Daftarkan diri Anda sekarang dan raih gelar Magister sesuai program pilihan Anda!</p>
              </div>
